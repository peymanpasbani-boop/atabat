...
if(d.hiHotels){
// Load hotel-iraq panel data from avan-data.json
const cityMap={najaf:'najaf',karbala:'karbala',kazimiya:'kazimiya'};
Object.keys(cityMap).forEach(city=>{
if(d.hiHotels[city]&&Array.isArray(d.hiHotels[city])){
// Override HI_HOTELS in-place
HI_HOTELS[city]=d.hiHotels[city];
}
});
...
${h.priceNum?`<span class="cty-hotel-opt-price">${h.priceNum.toLocaleString('fa-IR')} ت/شب</span>`:''}
